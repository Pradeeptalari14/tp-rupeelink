...
> Neuro-symbolic LLM query engine for Indian commerce. Includes Telegram and WhatsApp integration scripts.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rupeelink/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rupeelink.git
cd tp-rupeelink
```
...
```bash
kubectl port-forward deployment/tp-rupeelink 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── rupeelink_framework.py     # Main configuration file
```
...
---
*Generated by [RupeeLink Studio](https://pradeeptalari14.github.io/portfolio/tools/rupeelink/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
